...
base_path = "RI\\" # Set to folder where this code is located
test_name = base_path+"new_toefl.txt" # file with TOEFL dataset
data_file_name = base_path+"lemmatized.text" # file with the text corpus
...
print("Total unique words in the corpus: " + str(len(dictionary)))
# Print total words in the TOEFL dataset
print("Total words in the TOEFL dataset: " + str(len(word_space)))
# Print the estimated time for the whole corpus (There are 5 words per test in the TOEFL dataset)
print("Estimated time for the whole corpus: " + str((time.time() - start_time) * len(dictionary) / len(word_space)) + " seconds")
